  ...
  const renderLead = ({ item }: { item: any }) => {
    ...
    return (
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('AdminLeadDetail',
          { leadId: item._id })}
        activeOpacity={0.7}
      >
        ...
        <View style={styles.cardContent}>
          ...
          <View style={styles.cardTop}>
            ...
            <View style={styles.leadInfo}>
              ...
              {item.car && (
                <Text style={styles.leadCar}>🚗 {item.car}</Text>
              )}
            </View>
            ...
            <View style={styles.actionBtns}>
              ...
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate('AssignLead',
                  { leadId: item._id, currentEmployee: item.assignedTo })}
              >
                <Ionicons name="swap-horizontal" size={15}
                  color="#6366F1" />
              </TouchableOpacity>
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  assignBtn: { backgroundColor: '#EEF2FF' },
  emptyState: {
